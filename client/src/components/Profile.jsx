  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4">
        <h1 className="text-black text-center font-bold mt-6 mb-2 lg:text-7xl md:text-5xl sm:text-[3rem]">Twój profil</h1>
        ...
        <div role="tablist" className="tabs tabs-boxed flex justify-center gap-10 mb-8">
          <a
            ...
            className={panel ? "tab cursor-default bg-[#ff6d00] p-3 rounded-3xl h-12 w-42 ease-in-out duration-150" : "tab cursor-pointer bg-gray-700 text-white rounded-3xl h-12 w-42"}
          >
            Twoje składniki
          </a>
          <a
